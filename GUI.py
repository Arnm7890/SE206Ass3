...
class GUI:
    ...
    def __init__(self, master):
        ...
        self.editMenu.add_command(label="Remove selected word/s")
        self.editMenu.add_command(label="Merge lists")
        ...
        # Speech buttons
        self.createButton(self.speechFrame, 0, 0, "Test", speakSelected, colour="green")            ### This method (speakSelected) shows an error when clicked, saying that
